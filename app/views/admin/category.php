        ...
        <div class="col-lg-12 mb-4">
            <div class="card shadow mb-4">
                <div class="card-header">
                    <i class="fas fa-scroll"></i> Criar Categoria
                </div>
                <div class="card-body">
                    <form class="user" method="POST" action="category/save/<?= $category->id ?>">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12 mb-3 mb-sm-0">
                                ...
                                <div class="form-group form-check">
                                    <input type="checkbox" name="active" value="1" class="form-check-input" id="active" <?= isset($category->active) ? 'checked' : ''; ?>>
